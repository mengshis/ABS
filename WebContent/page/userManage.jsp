...
<body style="margin: 1px">
 <table id="dg" title="用户管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="telephone" width="50" align="center">电话</th>
   		<th field="idCardNumber" width="50" align="center">身份证号码</th>
 ...
 <div id="dlg" class="easyui-dialog" style="width:620px;height:380px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		<tr>
   			<td>真实姓名：</td>
   			<td><input type="text" id="realName" name="realName" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   			<td>昵称：</td>
   			<td><input type="text" id="nickName" name="nickName" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
   		</tr>
   		<tr>
   			<td>登录名：</td>
   		...
   		<tr>
   			<td>性别：</td>
   			<td><input type="text" id="sex" name="sex"  required="false"/>&nbsp;</td>
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   			<td>年龄：</td>
   		...
   		<tr>
   			<td>电话：</td>
   			<td><input type="text" id="telephone" name="telephone" class="easyui-validatebox" required="true"/>&nbsp;<font color="red">*</font></td>
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   			<td>身份证：</td>
   		...
   		<tr>
   			...
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   	 		 <td>创建时间：</td>
   			<td><input type="date" id="createTime" name="createTime"  class="easyui-validatebox"  required="true"/>&nbsp;</td>
   		</tr>
   		<tr>
   			<td>更新时间：</td>
   			<td><input type="date" id="updateTime" name="updateTime" class="easyui-validatebox"  required="true"/>&nbsp;</td>
   		</tr> 
   	</table>
   </form>
 </div>
